...
def add_supply_to_winter_holidays(holiday_hash, supply)
  ...
  holiday_hash.each do |season, season_detail|
    if season == :winter
      season_detail.each do |holiday_name, supplies|
        supplies << supply
      end
    end
  end
...
def all_winter_holiday_supplies(holiday_hash)
  ...
  holiday_hash.each do |season, season_detail|
    if season == :winter
      winter_holiday_supplies = season_detail.values.flatten
    end
  end
  winter_holiday_supplies
end
...
def all_supplies_in_holidays(holiday_hash)
  ...
  holiday_hash.each do |season, season_detail|
    ...
    season_detail.each do |holiday, supplies|
